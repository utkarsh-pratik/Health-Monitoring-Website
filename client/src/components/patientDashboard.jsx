...
const PatientDashboard = ({ patientId }) => {
  ...
  return (
    <div className="max-w-md   mx-auto mt-32    p-8 bg-gradient-to-br from-purple-200 via-pink-300 to-red-200 rounded-3xl shadow-2xl dark:from-gray-800 dark:via-gray-900 dark:to-black">
      ...
      {/* Question bubble with smooth fade and scale */}
      <div
        className={`relative mb-8 px-6 py-5 rounded-3xl max-w-full mx-auto bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100
      ...
      <input
        ...
        className="w-full rounded-xl border border-purple-300 dark:border-pink-600 px-4 py-3 text-lg
                   focus:outline-none focus:ring-4 focus:ring-purple-400 dark:focus:ring-pink-500
      ...
      <div className="flex justify-between mt-8">
        ...
        <button
          ...
          className="bg-purple-700 dark:bg-pink-500 text-white px-6 py-3 rounded-xl shadow-lg
                     hover:bg-purple-800 dark:hover:bg-pink-600 transition-all duration-300
